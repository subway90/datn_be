...
class ToaNhaSeeder extends Seeder
{
    public function run()
    {
        ToaNha::create(attributes: [
            ...
            'image' => 'http://localhost:8000/storage/building/img01.jpg;http://localhost:8000/storage/building/img02.jpg;http://localhost:8000/storage/building/img03.jpg;http://localhost:8000/storage/building/img04.jpg;http://localhost:8000/storage/building/img05.jpg',
            'gia_thue' => 3500000,
            'dien_tich' => 24,
